...
const Experience = () => {
    ...
    const handelSave = () => {
        ...
        axios.post(`${BASE_URL}/Experience`)
    ...
    return (
        <div className='experience'>
            <div className='form_itm' >
                ...
                <input className='input' type='text' value={company} onChange={((a) => setCompany(a.target.value))} />
            </div>
            <div className='form_itm' >
                <label className='label'>Enter Job Title</label>
                <input className='input' type='text' value={JobTitle} onChange={((a) => setJobTitle(a.target.value))} />
            </div>
            <div className='form_itm' >
            ...
            <div className='form_itm' >
                ...
                <textarea className='input' type='text' value={Description} onChange={((a) => setDescription(a.target.value))} />
            </div>
            <div className='edu_btn'>
                <button className='btn_1' onClick={() => handelSave()}>Save</button>
                <button className='btn_2'>Sikp</button>
            </div>
        </div>
    )
}
